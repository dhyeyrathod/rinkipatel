...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <iframe width="100%" height="480" src="https://www.youtube.com/embed/<?= $location_info_key->youtube_code ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
            </div>
        </div>
        <div class="container">
            <div class="row">
