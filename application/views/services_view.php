...
<html lang="en">
    <head>
        ...
        <title><?= $seivices_info_key->meta_title ?></title>
        <meta name="description" content="<?= $seivices_info_key->meta_description ?>" />
        <meta name="keywords" content="<?= $seivices_info_key->meta_keywords ?>" />
        ...
        <div class="container mb-4">
            <div class="col-lg-12 mb-2">
                <div class="section-title-bg mb-4">
                    <h1><?= $seivices_info_key->services_name ?></h1>
                </div>
            </div>
            <div class="bg">
                <?= $seivices_info_key->services_description ?>
            </div>
        </div>
        <div class="container">
            <div class="row">
